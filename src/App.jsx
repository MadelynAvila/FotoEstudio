...
import FotografoDashboard from './pages/FotografoDashboard'
...
export default function App(){
  return (
    <Routes>
      ...
      {/* Área privada de fotógrafos */}
      <Route element={<ProtectedRoute roles={["fotografo"]} />}>
        <Route element={<PublicLayout />}>
          <Route path="/fotografo" element={<FotografoDashboard />} />
        </Route>
      </Route>
    </Routes>
  )
